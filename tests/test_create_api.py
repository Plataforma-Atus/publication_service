...
def test_create_docx(payload):
    ...
    expected_payload = {'file': 'documents/Atus-Teste/2022/PV-2/2-9/PV-2_BrasíliaAgora-DF_QWEQWEQW_Sema_2_3x70mm',
...
def test_create_diario_cuiaba(payload_diario_de_cuiba):
    ...
    expected_payload = {'file': 'documents/Atus-Teste/2022/PV-4/2-9/PV-4_DC-MT_PDF_Edital_1_2x105mm', 'width': '5.60',
...
def test_create_folha_sp(payload_folha_sp):
    ...
    expected_payload = {'file': 'documents/Atus-Teste/2022/PV-4/2-9/PV-4_Folha-SP_PDF_Sema_1_1x190mm',
                        'width': '4.60',
...
def test_create_mato_grosso(payload_mato_grosso):
    ...
    expected_payload = {'file': 'documents/Atus-Teste/2022/PV-4/2-9/PV-4_DOMT-MT_PDF_Edital_1_1x161mm',
...
def test_create_ro(payload_ro):
    ...
    expected_payload = {'file': 'documents/Atus-Teste/2022/PV-4/2-9/PV-4_DORO-RO_PDF_Edital_1_1x200mm',
                        'width': '9.00',
...
def test_create_parana(payload_parana):
    ...
    expected_payload = {'file': 'documents/Atus-Teste/2022/PV-4/2-9/PV-4_DOPR-PR_PDF_Ata_1_1x150mm', 'width': '8.02',
...
def test_create_pernambuco(payload_pe):
    ...
    expected_payload = {
        'file': 'documents/Atus-Teste/2022/PV-4/2-9/PV-4_DiáriodePernambuco-PE_PDF_Sema_1_2x130mm',
...
def test_create_df(payload_df):
    ...
    expected_payload = {
        'file': 'documents/Atus-Teste/2022/PV-4/2-9/PV-4_BrasíliaAgora-DF_PDF_Edital_1_1x190mm',
...
def test_create_minas_gerais(payload_minas_gerais):
    ...
    expected_payload = {'file': 'documents/Atus-Teste/2022/PV-4/2-9/PV-4_DOMG-MG_PDF_Edital_1_2x70mm',
...
def test_create_amazonas(payload_amazonas):
    ...
    expected_payload = {'file': 'documents/Atus-Teste/2022/PV-4/2-9/PV-4_DOAM-AM_PDF_Edital_1_1x190mm', 'width': '9.49', 'height': '19.00', 'price': '1482.00', 'price_by_cm': '8.22', 'newspaper': 'Particulares - DOAM - AM', 'chars_count': 4836, 'format_out': '.docx'}
...
def test_create_maranhao(payload_maranhao):
    ...
    expected_payload = {'file': 'documents/Atus-Teste/2022/PV-4/2-9/PV-4_DOMA-MA_PDF_Sema_1_2x110mm', 'width': '17.00', 'height': '11.00', 'price': '154.00', 'price_by_cm': '0.82', 'newspaper': 'Terceiros - DOMA - MA', 'chars_count': 4875, 'format_out': '.rtf'}
...
def test_a_gazeta_df(a_gazeta_df):
    ...
    expected_payload = {'file': 'documents/Atus-Teste/2022/PV-444/2-9/PV-444_AGazeta-DF_TEST_Sema_2_1x340mm',
...
def test_a_gazeta_mt(a_gazeta_mt):
    ...
    expected_payload = {'file': 'documents/Atus-Teste/2022/PV-444/2-9/PV-444_AGazeta-MT_TEST_Edital_2_1x145mm',
...
def test_valor_economico_rj(valor_economico_rj):
    ...
    expected_payload = {'file': 'documents/Atus-Teste/2022/PV-2/2-9/PV-2_ValorEconômico-RJ_TEST_Ata_1_3x120mm',
...
def test_o_progresso_ma(o_progresso_ma):
    ...
    expected_payload = {'file': 'documents/Atus-Teste/2022/PV-2/2-9/PV-2_OProgresso-MA_TEST_Sema_1_1x220mm',
...
def test_o_estado_ms(o_estado_ms):
    ...
    expected_payload = {'file': 'documents/Atus-Teste/2022/PV-2/2-9/PV-2_OEstado-MS_TEST_Sema_1_1x380mm',
...
def test_o_dia_sp(o_dia_sp):
    ...
    expected_payload = {'file': 'documents/Atus-Teste/2022/PV-2/2-9/PV-2_ODia-SP_TEST_Edital_1_2x100mm',
