...
def test_calculate_budget_by_centimeter(result, format_parameters):
    response = Budget.calculate_budget_by_centimeter(result, format_parameters)
...
def test_make_budget(result, format_parameters):
    response = Budget.make_budget(result, format_parameters)
...
def test_calculate_budget_by_character(result, format_parameters):
    response = Budget.calculate_budget_by_character(result, format_parameters)
    result_price: float = float(response[1]['price_cm']) * float(response[1]['chars_count'])
    assert result_price


def test_calculate_price_by_centimeter_square(result, format_parameters):
    response = Budget.calculate_price_by_centimeter_square(result, format_parameters)
