...
def format_margins(format_parameters):
    ...
    if format_parameters['name_section'] in fstring.newspapers['special_format_a4'] and format_parameters[
        'number_column'] == 1:
        document_margins[2] = 13
    elif format_parameters['name_section'] in fstring.newspapers['special_format_a4'] and format_parameters[
        'number_column'] == 2:
