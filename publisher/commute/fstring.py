...
newspapers = {
    'budget_by_character': ["Terceiros - DORO - RO"],
    'budget_by_half_centimeter': ["Terceiros - DC - MT", "Terceiros - A Gazeta - MT"],
    'insert_date': ["Terceiros - DC - MT"],
    'special_format_a4': ["Comércio, Indústria e Serviços - DOPR - PR"],
    'special_format_head_spaced': ["Particulares - DOBA - BA"],
}